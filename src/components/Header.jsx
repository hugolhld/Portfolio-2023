...
const Header = () => {
    ...
    const topLeftStyleScroll = 'w-16 rounded-full'
  ...
  return (
    <header ref={headerRef} className='w-full transition fixed z-20'>
        ...
        <div className='w-5/5 flex  mx-auto transition'>

            <div className={`w-1/3 justify-center flex py-8`}>
            ...
            <div className="w-2/3 flex justify-center" >
                ...
                <div className={` ${isScrolling ? topRightStyleScroll : topRightStyleInit} bg-blacks flex items-center justify-center px-8`}style={{background: 'linear-gradient(-92.46deg, rgba(187, 21, 41) 0.94%, rgba(143, 29, 197) 52.06%)', boxShadow: '0px 3px 4px 1px rgba(0, 0, 0, 0.25)'}}>
                    <ul className='text-white text-md flex gap-8 justify-around'>
