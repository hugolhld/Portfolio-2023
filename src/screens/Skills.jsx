...
const Skills = () => {
  return (
    <section id='skills' className='w-full mx-16 h-screen flex flex-col justify-center items-center snapelement'>
        {/* <h2 className='text-3xl text-start font-semibold text-white p-16'>.Skills</h2> */}
        <TitleSection title={'.Skills'} />
        <ul className='flex w-4/5  justify-between items-center flex-wrap mx-auto gap-y-4'>
          
          <li className='flex justify-center w-1/3 group perspective ' >
